...
&#160; &#160; &#160; &#160;图书管理员的属性有姓名、职工号、登录密码，通过密码和职工号登录图书管理系统。借书记录中包含借书时间、应还时间、归还时间和经办人。结束时间是该条借书记录生成的时间，应还时间是根据结束时间和所借资源可借天数自动生成的，归还时间为读者归还资源的时间，若暂未归还则为空。读者借书时由管理员登记，经办人为登记的管理员。
